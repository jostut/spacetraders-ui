...
export const FleetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async extractResourcesWithSurvey(shipSymbol: string, survey?: Survey, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExtractResources201Response>> {
         ...
         * @throws {RequiredError}
         */
        async patchShipNav(shipSymbol: string, patchShipNavRequest?: PatchShipNavRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetShipNav200Response>> {
